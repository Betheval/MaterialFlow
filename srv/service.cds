using { Materials as m, Suppliers as s, Categories as c, PurchaseOrders as po, PurchaseOrderItems as poi, InventoryMovement as im } from '../db/schema';
service MFlowService @(requires:'authenticated-user') {
    ...
    @requires: 'MaterialFlow.Supervise'
